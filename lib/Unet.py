...
class UNET(nn.Module):
    def __init__(self,task_num, in_channels , out_channels , features=[64,128,256,512]):
        ...
        #     self.last.append(nn.Conv2d(features[0],out_channels, kernel_size=1))
...
def test():
    ...
    model = UNET(task_num=6, in_channels=1, out_channels=1)
    preds = model(x)
    print(preds[2])
